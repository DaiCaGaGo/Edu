<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="NguoiDungDonVi.aspx.cs" Inherits="CMS.QuanTri.NguoiDungDonVi" %>
    ...
    <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true" OnClientClose="RadWindowManager1_OnClientClose">
        <Windows>
            <telerik:RadWindow RenderMode="Lightweight" ID="RadWindow1" runat="server" ShowContentDuringLoad="false" Width="400px"
                Height="400px" Title="Chi tiết người dùng" Behaviors="Reload,Close,Maximize" Modal="true" VisibleStatusbar="false">
            </telerik:RadWindow>
        </Windows>
    ...
    <div class="item-content">
        <div class="row item-header">
            ...
            <div class="col-sm-8 text-right">
                ...
                <input type="button" id="btAddNew" runat="server" class="btn bt-one" value="Thêm mới" onclick="openRadWin('NguoiDungDonViDetail.aspx', 100, 50)" />
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" GroupPanelPosition="Top" OnNeedDataSource="RadGrid1_NeedDataSource"
                ...
                <MasterTableView DataKeyNames="ID" ClientDataKeyNames="ID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="TEN_DANG_NHAP" HeaderStyle-Width="150px" FilterControlAltText="Filter TEN_DANG_NHAP column" HeaderText="Tên đăng nhập" SortExpression="TEN" UniqueName="TEN_DANG_NHAP" HeaderStyle-HorizontalAlign="Center">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="TEN_HIEN_THI" HeaderStyle-Width="150px" FilterControlAltText="Filter TEN_HIEN_THI column" HeaderText="Tên hiển thị" SortExpression="TEN_HIEN_THI" UniqueName="TEN_HIEN_THI" HeaderStyle-HorizontalAlign="Center">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Phân quyền" HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" UniqueName="SET_QUYEN">
                            <ItemTemplate>
                                <img src="../img/sua.png" onclick='<%# "openRadWin(\"PhanQuyenMenuNguoiDungDonVi.aspx?id_user=" + Eval("ID") + "\",100,50)" %>' style="cursor: pointer;" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Sửa" HeaderStyle-Width="60px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" UniqueName="SUA">
                            <ItemTemplate>
                                <img src="../img/sua.png" onclick='<%# "openRadWin(\"NguoiDungDonViDetail.aspx?id_hoso=" + Eval("ID") + "\",100,50)" %>' style="cursor: pointer;" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
