<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterSYS.Master" AutoEventWireup="true" CodeBehind="NhomQuyen.aspx.cs" Inherits="CMS.QuanTri.NhomQuyen" %>
    ...
    <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true" OnClientClose="RadWindowManager1_OnClientClose">
        <Windows>
            <telerik:RadWindow RenderMode="Lightweight" ID="RadWindow1" runat="server" ShowContentDuringLoad="false" Width="400px"
                Height="400px" Title="Chi tiết nhóm quyền" Behaviors="Reload,Close,Maximize" Modal="true" VisibleStatusbar="false">
            </telerik:RadWindow>
        </Windows>
    ...
    <div class="item-content">
        <div class="row item-header">
            ...
            <div class="col-sm-8 text-right">
                ...
                <input type="button" id="btAddNew" runat="server" class="btn bt-one" value="Thêm mới" onclick="openRadWin('NhomQuyenDetail.aspx', 100, 50)" />
                <asp:Button ID="btDeleteChon" runat="server" CssClass="btn bt-one" OnClick="btDeleteChon_Click" Text="Xóa nhóm quyền" OnClientClick="if(!btDeteleClick()) return false;" />
            </div>
        ...
        <div class="item-filter">
            <div class="row">
                <div class="col-sm-5">
                    <telerik:RadTextBox ID="rtbTen" runat="server" EmptyMessage="Nhập tên nhóm quyền cần tìm kiếm" Width="100%"></telerik:RadTextBox>
                </div>
                <div class="col-sm-4">
                    <telerik:RadTextBox ID="rtbMa" runat="server" EmptyMessage="Nhập mã nhóm quyền cần tìm kiếm" Width="100%"></telerik:RadTextBox>
                </div>
            </div>
        </div>
        <div class="item-data">
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" GroupPanelPosition="Top" OnNeedDataSource="RadGrid1_NeedDataSource"
                ...
                <MasterTableView DataKeyNames="MA" ClientDataKeyNames="MA">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="MA" HeaderStyle-Width="200px" FilterControlAltText="Filter MA column" HeaderText="Mã nhóm" SortExpression="MA" UniqueName="MA" HeaderStyle-HorizontalAlign="Center">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Sửa" HeaderStyle-Width="60px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" UniqueName="SUA">
                            <ItemTemplate>
                                <img src="../img/sua.png" onclick='<%# "openRadWin(\"NhomQuyenDetail.aspx?ma_nq=" + Eval("MA") + "\",100,50)" %>' style="cursor: pointer;" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
