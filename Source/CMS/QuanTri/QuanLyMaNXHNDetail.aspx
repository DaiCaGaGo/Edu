<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPopup.Master" AutoEventWireup="true" CodeBehind="QuanLyMaNXHNDetail.aspx.cs" Inherits="CMS.QuanTri.QuanLyMaNXHNDetail" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="rcbCapHoc" class="col-sm-3 control-label">Cấp học <span style="color: red">(*)</span></label>
                            <div class="col-sm-9">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="rcbCapHoc"
