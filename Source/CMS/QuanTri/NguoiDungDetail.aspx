<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPopup.Master" AutoEventWireup="true" CodeBehind="NguoiDungDetail.aspx.cs" Inherits="CMS.QuanTri.NguoiDungDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="chbLaDaiLy">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="divDaiLy" UpdatePanelCssClass="" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
    ...
    <div class="item-content">
        <div class="row item-header">
            <div class="col-sm-4">
                <span class="item-title">CHI TIẾT NGƯỜI DÙNG</span>
            </div>
            <div class="col-sm-8 text-right">
                ...
                <input type="button" id="btNguoiDungTruong" runat="server" class="btn bt-one" value="Phân quyền người dùng theo trường" />
            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                <asp:CustomValidator ID="CustomValidator2" ControlToValidate="txtUser" ClientValidationFunction="validateMaxchar" ValidateEmptyText="true"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                <asp:CustomValidator ID="CustomValidator3" ControlToValidate="txtPass" ClientValidationFunction="validateMaxchar" ValidateEmptyText="true"
                                    runat="server" CssClass="valid-control" ForeColor="Red" Display="Dynamic" ErrorMessage="Thông tin bắt buộc, nhập không quá 100 ký tự." />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group" style="margin-bottom: -15px;">
                                    <div class="col-sm-5" style="margin-top: 5px;">
                                        <asp:CheckBox ID="chbLaDaiLy" CssClass="one-checkbox" runat="server" OnCheckedChanged="chbLaDaiLy_CheckedChanged" AutoPostBack="true"/>
                                    </div>
                                    <div class="col-sm-7" runat="server" id="divDaiLy" visible="false">
