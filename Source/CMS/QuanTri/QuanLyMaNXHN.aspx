<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterSYS.Master" AutoEventWireup="true" CodeBehind="QuanLyMaNXHN.aspx.cs" Inherits="CMS.QuanTri.QuanLyMaNXHN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="item-content">
        <div class="row item-header">
            <div class="col-sm-4">
                <span class="item-title">QUẢN LÝ MÃ NHẬN XÉT HÀNG NGÀY</span>
            </div>
            <div class="col-sm-8 text-right">
                <asp:Button ID="btTimKiem" runat="server" Text="Tìm kiếm" CssClass="btn bt-one" OnClick="btTimKiem_Click" />
                <input type="button" id="btAddNew" runat="server" class="btn bt-one" value="Thêm mới" onclick="openRadWin('QuanLyMaNXHNDetail.aspx', 860, 350, 1)" />
        ...
        <div class="item-filter">
            <div class="row">
                <div class="col-sm-3">
                    <telerik:RadComboBox ID="rcbCapHoc" runat="server" Width="100%" OnSelectedIndexChanged="rcbCapHoc_SelectedIndexChanged" AutoPostBack="true" Filter="Contains" EmptyMessage="Chọn cấp học" AllowCustomText="true">
                    </telerik:RadComboBox>
                </div>
                <div class="col-sm-3">
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" GroupPanelPosition="Top" OnNeedDataSource="RadGrid1_NeedDataSource"
                ...
                <MasterTableView DataKeyNames="ID" ClientDataKeyNames="ID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="MA_CAP_HOC" HeaderStyle-Width="150px" FilterControlAltText="Filter MA_CAP_HOC column" HeaderText="Cấp học" SortExpression="MA_CAP_HOC" UniqueName="MA_CAP_HOC" HeaderStyle-HorizontalAlign="Center">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="MA" HeaderStyle-Width="80px" FilterControlAltText="Filter MA column" HeaderText="Mã nhận xét" SortExpression="MA" UniqueName="MA" HeaderStyle-HorizontalAlign="Center">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Sửa" HeaderStyle-Width="60px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" UniqueName="SUA">
                            <ItemTemplate>
                                <img src="../img/sua.png" onclick='<%# "openRadWin(\"QuanLyMaNXHNDetail.aspx?id=" + Eval("ID") + "\", 860, 400, 1)" %>' style="cursor: pointer;" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
