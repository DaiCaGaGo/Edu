...
{
    public partial class ToCustomer : AuthenticatePage
    {
        ...
        {
            RadGrid1.DataSource = customerToBO.getToCustomer(Sys_This_Truong.ID, rtbTen.Text.Trim());
        }
        protected void btDeleteChon_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridDataItem row in RadGrid1.SelectedItems)
            {
                try
                {
                    ...
                    try
                    {
                        ResultEntity res = customerToBO.delete(id, Sys_User.ID, true);
                        lst_id += id + ":" + ten + ", ";
                        if (res.Res)
                        {
                            success++;
                            logUserBO.insert(Sys_This_Truong.ID, "DELETE", "Xóa tổ customer " + ten + " (" + id + ")", Sys_User.ID, DateTime.Now);
                        }
                        else
                            error++;
                    }
        ...
        protected void btExport_Click(object sender, EventArgs e)
        {
            ...
            if (localAPI.checkColumnShowInRadGrid(RadGrid1, "TEN"))
            {
                ...
                dt.Columns.Add(col);
                lstHeader.Add(new ExcelHeaderEntity { name = "Tên tổ/nhóm", colM = 1, rowM = 1, width = 60 });
            ...
            string tieuDe = "DANH SÁCH TỔ/NHÓM";
            string hocKyNamHoc = "";
