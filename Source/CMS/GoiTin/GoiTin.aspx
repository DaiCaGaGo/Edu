<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterSYS.Master" AutoEventWireup="true" CodeBehind="GoiTin.aspx.cs" Inherits="CMS.GoiTin.GoiTin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true" OnClientClose="RadWindowManager1_OnClientClose">
        <Windows>
            <telerik:RadWindow RenderMode="Lightweight" ID="RadWindow1" runat="server" ShowContentDuringLoad="false" Width="400px"
                Height="400px" Title="Chi tiết gói tin" Behaviors="Reload,Close,Maximize" Modal="true" VisibleStatusbar="false">
            </telerik:RadWindow>
        </Windows>
    ...
    <div class="item-content">
        <div class="row item-header">
            <div class="col-sm-4">
                <span class="item-title">QUẢN LÝ GÓI TIN</span>
            </div>
            <div class="col-sm-8 text-right">
                <asp:Button ID="btTimKiem" runat="server" Text="Tìm kiếm" CssClass="btn bt-one" OnClick="btTimKiem_Click"/>
                <input type="button" id="btAddNew" runat="server" class="btn bt-one" value="Thêm mới" onclick="openRadWin('GoiTinDetail.aspx',  860, 500, 1)" />
        ...
        <div class="item-filter">
            <div class="row">
                <div class="col-sm-3">
                    <telerik:RadTextBox ID="tbTen" runat="server" EmptyMessage="Nhập tên gói tin cần tìm kiếm" Width="100%"></telerik:RadTextBox>
                </div>
            </div>
        </div>
        <div class="item-data">
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" GroupPanelPosition="Top" OnNeedDataSource="RadGrid1_NeedDataSource"
                ...
                <MasterTableView DataKeyNames="MA" ClientDataKeyNames="MA">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="SO_TIN_LIEN_LAC_HS" FilterControlAltText="Filter SO_TIN_LIEN_LAC_HS column" HeaderText="Số tin liên lạc (/tuần)" SortExpression="SO_TIN_LIEN_LAC_HS" UniqueName="SO_TIN_LIEN_LAC_HS" HeaderStyle-HorizontalAlign="Center">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="SO_TIN_THONG_BAO_HS" FilterControlAltText="Filter SO_TIN_THONG_BAO_HS column" HeaderText="Số tin thông báo (/tháng)" SortExpression="SO_TIN_THONG_BAO_HS" UniqueName="SO_TIN_THONG_BAO_HS" HeaderStyle-HorizontalAlign="Center">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="SO_TIN_HE_HS" FilterControlAltText="Filter SO_TIN_HE_HS column" HeaderText="Số tin hè" SortExpression="SO_TIN_HE_HS" UniqueName="SO_TIN_HE_HS" HeaderStyle-HorizontalAlign="Center">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Sửa" HeaderStyle-Width="60px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" UniqueName="SUA">
                            <ItemTemplate>
                                <img src="../img/sua.png" onclick='<%# "openRadWin(\"GoiTinDetail.aspx?ma=" + Eval("MA") + "\", 860, 500, 1)" %>' style="cursor: pointer;" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
