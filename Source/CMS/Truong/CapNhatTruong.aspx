<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="CapNhatTruong.aspx.cs" Inherits="CMS.Truong.CapNhatTruong" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="item-content">
        <div class="row item-header">
            <div class="col-sm-4">
                <span class="item-title">cập nhật hồ sơ trường</span>
            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <div class="col-sm-7 col-sm-offset-5">
                                <asp:CheckBox ID="chbIsActive" Text="Đăng ký SMS" CssClass="one-checkbox" runat="server" Enabled="false" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-5 control-label">Trạng thái</label>
                            <div class="col-sm-7">
                                <telerik:RadComboBox ID="rcbTrangThai" runat="server" Width="100%" EmptyMessage="Trạng thái trường học" AllowCustomText="true" Filter="Contains" Enabled="false">
                                    <Items>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group" style="margin-bottom: -15px;">
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="tbThuongHieu" CssClass="form-control" ClientIDMode="Static" placeholder="Tên thương hiệu" runat="server" MaxLength="50" Width="100%" Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-6">
                                        <telerik:RadComboBox ID="rcbCPVietTel" runat="server" EnableCheckAllItemsCheckBox="true" Width="100%" EmptyMessage="Chọn đối tác" AllowCustomText="true" Filter="Contains" DataSourceID="objDoiTac" DataTextField="TEN" DataValueField="MA" Enabled="false">
                                        </telerik:RadComboBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group" style="margin-bottom: -15px;">
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="tbVina" CssClass="form-control" ClientIDMode="Static" placeholder="Tên thương hiệu" runat="server" MaxLength="50" Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-6">
                                        <telerik:RadComboBox ID="rcbCPViNa" runat="server" EnableCheckAllItemsCheckBox="true" Width="100%" EmptyMessage="Chọn đối tác" AllowCustomText="true" Filter="Contains" DataSourceID="objDoiTac" DataTextField="TEN" DataValueField="MA" Enabled="false">
                                        </telerik:RadComboBox>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group" style="margin-bottom: -15px;">
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="tbMobi" CssClass="form-control" ClientIDMode="Static" placeholder="Tên thương hiệu" runat="server" MaxLength="50" Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-6">
                                        <telerik:RadComboBox ID="rcbCPMobi" runat="server" EnableCheckAllItemsCheckBox="true" Width="100%" EmptyMessage="Chọn đối tác" AllowCustomText="true" Filter="Contains" DataSourceID="objDoiTac" DataTextField="TEN" DataValueField="MA" Enabled="false">
                                        </telerik:RadComboBox>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group" style="margin-bottom: -15px;">
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="tbGtel" CssClass="form-control" ClientIDMode="Static" placeholder="Tên thương hiệu" runat="server" MaxLength="50" Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-6">
                                        <telerik:RadComboBox ID="rcbCPGtel" runat="server" EnableCheckAllItemsCheckBox="true" Width="100%" EmptyMessage="Chọn đối tác" AllowCustomText="true" Filter="Contains" DataSourceID="objDoiTac" DataTextField="TEN" DataValueField="MA" Enabled="false">
                                        </telerik:RadComboBox>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group" style="margin-bottom:-15px;">
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="tbVNM" CssClass="form-control" ClientIDMode="Static" placeholder="Tên thương hiệu" runat="server" MaxLength="50" Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-6">
                                        <telerik:RadComboBox ID="rcbCPVNM" runat="server" EnableCheckAllItemsCheckBox="true" Width="100%" EmptyMessage="Chọn đối tác" AllowCustomText="true" Filter="Contains" DataSourceID="objDoiTac" DataTextField="TEN" DataValueField="MA" Enabled="false">
                                        </telerik:RadComboBox>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <telerik:RadComboBox ID="rcbMaGoiTin" runat="server" Width="100%" EmptyMessage="Chọn mã gói tin" DataSourceID="objMaGoiTin"
                                    DataTextField="TEN" DataValueField="MA" AllowCustomText="true" Filter="Contains" Enabled="false">
                                </telerik:RadComboBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <asp:TextBox ID="tbSoHSDangKy" CssClass="form-control" ClientIDMode="Static" placeholder="Số học sinh đăng ký" runat="server" MaxLength="4" TextMode="Number" Enabled="false"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="tbSoHSDuocMien" class="col-sm-5 control-label">Số học sinh miễn phí</label>
                            <div class="col-sm-7">
                                <asp:TextBox ID="tbSoHSDuocMien" CssClass="form-control" ClientIDMode="Static" placeholder="Số học sinh miễn phí" runat="server" MaxLength="4" TextMode="Number" Enabled="false"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="tbPhanTramVuot" class="col-sm-5 control-label">Phần trăm vượt hạn mức</label>
                            <div class="col-sm-7">
                                <asp:TextBox ID="tbPhanTramVuot" CssClass="form-control" ClientIDMode="Static" placeholder="% vượt hạn mức" runat="server" MaxLength="4" TextMode="Number" Enabled="false"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <telerik:RadComboBox ID="rcbDaiLy" runat="server" Width="100%" EmptyMessage="Chọn đại lý" DataSourceID="objDaiLy"
                                    DataTextField="TEN" DataValueField="ID" AllowCustomText="true" Filter="Contains" Enabled="false">
                                </telerik:RadComboBox>
