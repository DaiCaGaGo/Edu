...
{
    public partial class InPhieuLienLac_TH : AuthenticatePage
    {
        ...
        protected void btTimKiem_Click(object sender, EventArgs e)
        {
            try
            {
                List<PhieuDanhGiaDinhKy_TH> lst = hsBO.getPhieuLienLac(Sys_This_Truong.ID, Convert.ToInt16(Sys_Ma_Nam_hoc), Convert.ToInt16(Sys_Hoc_Ky), localAPI.ConvertStringToShort(rcbKhoi.SelectedValue), localAPI.ConvertStringToShort(rcbLop.SelectedValue), Sys_This_Cap_Hoc, Sys_This_Truong.TEN);
                ...
                string ReportID = "PhieuLienLacTH";
                Session["DatareportPhieuLienLacTH" + ReportID] = lst;
