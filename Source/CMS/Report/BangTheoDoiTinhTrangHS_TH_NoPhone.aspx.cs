...
{
    public partial class BangTheoDoiTinhTrangHS_TH_NoPhone : AuthenticatePage
    {
        ...
        protected void btTimKiem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string ReportID = "BTDHS_TH_NoPhone";
                Session["DatareportBTDHS_TH_NoPhone" + ReportID] = lst;
