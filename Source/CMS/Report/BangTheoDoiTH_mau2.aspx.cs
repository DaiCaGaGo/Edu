...
{
    public partial class BangTheoDoiTH_mau2 : AuthenticatePage
    {
        ...
        protected void btTimKiem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (count_HS > 0 && count_HS < 40)
                {
                    for (int i = 1; i <= 40 - count_HS; i++)
                    {
                ...
                string ReportID = "BTDHS_Mau2";
                Session["DatareportBTDHS_Mau2" + ReportID] = lst;
