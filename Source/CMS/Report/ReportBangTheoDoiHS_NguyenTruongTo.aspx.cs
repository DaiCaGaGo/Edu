...
{
    public partial class ReportBangTheoDoiHS_NguyenTruongTo : AuthenticatePage
    {
        ...
        protected void btTimKiem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string ReportID = "BTDHS_THCS_NguyenTruongTo";
                Session["DatareportBTDHS_THCS_NguyenTruongTo" + ReportID] = lst;
