...
{
    public partial class BangTheoDoiTinhTrangHS_THCS_NoPhone : AuthenticatePage
    {
        ...
        protected void btTimKiem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string ReportID = "BTDHS_THCS_NoPhone";
                Session["DatareportBTDHS_THCS_NoPhone" + ReportID] = lst;
