...
{
    public partial class ReportBangTheoDoiHS_HaiBaTrung : AuthenticatePage
    {
        ...
        protected void btTimKiem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string ReportID = "BTDHS_THCS_HaiBaTrung";
                Session["DatareportBTDHS_THCS_HaiBaTrung" + ReportID] = lst;
