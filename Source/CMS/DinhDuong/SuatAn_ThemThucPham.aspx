<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPopup.Master" AutoEventWireup="true" CodeBehind="SuatAn_ThemThucPham.aspx.cs" Inherits="CMS.DinhDuong.SuatAn_ThemThucPham" %>
    ...
    <div class="item-content">
        ...
        <div class="item-filter">
            <div class="row">
                ...
                <div class="col-sm-2">
                    <telerik:RadComboBox ID="rcbKhoi" runat="server" Width="100%" DataTextField="TEN" DataValueField="MA" EmptyMessage="Chọn khối học" AllowCustomText="true" Filter="Contains" CausesValidation="false" DataSourceID="objKhoi" OnSelectedIndexChanged="rcbKhoi_SelectedIndexChanged" AutoPostBack="True">
                    </telerik:RadComboBox>
                ...
                <div class="col-sm-2">
                    <telerik:RadComboBox ID="rcbBuaAn" runat="server" Width="100%" DataSourceID="objBuaAn"
                        DataTextField="TEN" DataValueField="ID" EmptyMessage="Chọn bữa ăn" AllowCustomText="true" Filter="Contains" OnSelectedIndexChanged="rcbBuaAn_SelectedIndexChanged" AutoPostBack="true">
                    </telerik:RadComboBox>
