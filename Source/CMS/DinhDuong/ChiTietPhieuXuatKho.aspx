<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPopup.Master" AutoEventWireup="true" CodeBehind="ChiTietPhieuXuatKho.aspx.cs" Inherits="CMS.DinhDuong.ChiTietPhieuXuatKho" %>
                ...
                <div class="row">
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="rcbNguoiXuatHang" class="col-sm-6 control-label">Người nhận hàng <span style="color: red">(*)</span></label>
                                    <div class="col-sm-6">
