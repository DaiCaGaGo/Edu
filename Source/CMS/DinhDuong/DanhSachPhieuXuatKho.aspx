<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="DanhSachPhieuXuatKho.aspx.cs" Inherits="CMS.DinhDuong.DanhSachPhieuXuatKho" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" OnAjaxRequest="RadAjaxManager1_AjaxRequest">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="rcbNguoiXuatHang">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RadGrid1" UpdatePanelCssClass="" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true" OnClientClose="RadWindowManager1_OnClientClose">
        <Windows>
            <telerik:RadWindow RenderMode="Lightweight" ID="RadWindow1" runat="server" ShowContentDuringLoad="false" Width="400px"
                Height="400px" Title="Chi tiết phiếu xuất" Behaviors="Reload,Close,Maximize" Modal="true" VisibleStatusbar="false">
            </telerik:RadWindow>
        </Windows>
    ...
    <div class="item-content">
        <div class="row item-header">
            <div class="col-sm-4">
                <span class="item-title">danh sách phiếu xuất</span>
            </div>
            <div class="col-sm-8 text-right">
                <input type="button" id="btnXuat" runat="server" class="btn bt-one" value="Thêm phiếu xuất" onclick="openRadWin('PhieuXuatKho.aspx', 100, 50)" />
        ...
        <div class="item-filter">
            <div class="row">
                ...
                <div class="col-sm-3">
                    <telerik:RadComboBox ID="rcbNguoiXuatHang" runat="server" Width="100%" DataSourceID="objNhanVien" EmptyMessage="Chọn người xuất kho" DataTextField="HO_TEN" DataValueField="ID" AllowCustomText="true" Filter="Contains" OnSelectedIndexChanged="rcbNguoiXuatHang_SelectedIndexChanged" AutoPostBack="true">
                    </telerik:RadComboBox>
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" GroupPanelPosition="Top" OnNeedDataSource="RadGrid1_NeedDataSource" OnItemDataBound="RadGrid1_ItemDataBound"
                ...
                <MasterTableView DataKeyNames="ID" ClientDataKeyNames="ID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="NGAY_XUAT_KHO" FilterControlAltText="Filter NGAY_XUAT_KHO column" HeaderText="Ngày xuất" SortExpression="NGAY_XUAT_KHO" UniqueName="NGAY_XUAT_KHO" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="200px" ItemStyle-HorizontalAlign="Center">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="ID_NGUOI_XUAT_HANG" FilterControlAltText="Filter ID_NGUOI_XUAT_HANG column" HeaderText="ID_NGUOI_XUAT_HANG" SortExpression="ID_NGUOI_XUAT_HANG" UniqueName="ID_NGUOI_XUAT_HANG" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" Display="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="NGUOI_XUAT_HANG" FilterControlAltText="Filter NGUOI_XUAT_HANG column" HeaderText="Người xuất hàng" SortExpression="NGUOI_XUAT_HANG" UniqueName="NGUOI_XUAT_HANG" HeaderStyle-HorizontalAlign="Center">
                        </telerik:GridBoundColumn>
                        <telerik:GridTemplateColumn HeaderText="Sửa" HeaderStyle-Width="60px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" UniqueName="SUA">
                            <ItemTemplate>
                                <img src="../img/sua.png" onclick='<%# "openRadWin(\"ChiTietPhieuXuatKho.aspx?id_phieu_xuat=" + Eval("ID") + "\",100, 50)" %>' style="cursor: pointer;" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
