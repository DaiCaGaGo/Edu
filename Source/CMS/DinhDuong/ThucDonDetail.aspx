<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPopup.Master" AutoEventWireup="true" CodeBehind="ThucDonDetail.aspx.cs" Inherits="CMS.DinhDuong.ThucDonDetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="rcbKhoi">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="hdfSoTien1HS" />
                    <telerik:AjaxUpdatedControl ControlID="tbGia" />
                    <telerik:AjaxUpdatedControl ControlID="RadGrid1" UpdatePanelCssClass="" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        ...
        <script>
            ...
            function changeSoLuong() {
                try {
                    ...
                    //Nếu thành phần dinh dưỡng trong thực đơn chưa đạt chuẩn thì chuyển màu đỏ
    ...
    <div class="item-content">
        <div class="row item-header">
            <div class="col-sm-4">
                <span class="item-title">CHI TIẾT thực đơn</span>
            </div>
            <div class="col-sm-8 text-right">
                ...
                <input type="button" id="tbnThemThucPham" runat="server" class="btn bt-one" value="Thêm thực phẩm" onclick="openRadWin('ThemThucPhamThucDon.aspx', 100, 50)" />
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <asp:TextBox ID="tbTen" CssClass="form-control" ClientIDMode="Static" placeholder="Tên thực đơn" runat="server" MaxLength="50"></asp:TextBox>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <%--<div class="col-sm-7">
                                <asp:TextBox ID="tbSoHocSinhDK" CssClass="form-control" ClientIDMode="Static" placeholder="Số học sinh đăng ký" runat="server" MaxLength="4" TextMode="Number" onchange="text_changed(this)" OnTextChanged="tbSoHocSinhDK_TextChanged" AutoPostBack="true"></asp:TextBox>
                            </div>--%>
                            <div class="col-sm-7">
                ...
                <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" GroupPanelPosition="Top" OnNeedDataSource="RadGrid1_NeedDataSource" OnItemDataBound="RadGrid1_ItemDataBound" OnPreRender="RadGrid1_PreRender"
                    ...
                    <MasterTableView>
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="IS_NANG_LUONG_THUC_DON" FilterControlAltText="Filter IS_NANG_LUONG_THUC_DON column" HeaderText="IS_NANG_LUONG_THUC_DON" SortExpression="IS_NANG_LUONG_THUC_DON" UniqueName="IS_NANG_LUONG_THUC_DON" HeaderStyle-HorizontalAlign="Center" Display="false">
                            </telerik:GridBoundColumn>
                        </Columns>
