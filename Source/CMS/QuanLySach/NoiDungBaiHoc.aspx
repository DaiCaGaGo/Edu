<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="NoiDungBaiHoc.aspx.cs" Inherits="CMS.QuanLySach.NoiDungBaiHoc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" OnAjaxRequest="RadAjaxManager1_AjaxRequest">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="rcbBaiHoc">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RadGrid1" UpdatePanelCssClass="" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true" OnClientClose="RadWindowManager1_OnClientClose">
        <Windows>
            <telerik:RadWindow RenderMode="Lightweight" ID="RadWindow1" runat="server" ShowContentDuringLoad="false" Width="400px"
                Height="400px" Title="Chi tiết bài học" Behaviors="Reload,Close,Maximize" Modal="true" VisibleStatusbar="false">
            </telerik:RadWindow>
        </Windows>
    ...
    <div class="item-content">
        <div class="row item-header">
            <div class="col-sm-4">
                <span class="item-title">Nội dung bài học</span>
            </div>
            <div class="col-sm-8 text-right">
                <input type="button" id="btAddNew" runat="server" class="btn bt-one" value="Thêm mới" onclick="openRadWin('NoiDungBaiHocDetail.aspx', 860, 700, 1)" />
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <telerik:RadComboBox ID="rcbSach" runat="server" Width="100%" DataSourceID="objSach"
                        DataTextField="TEN" DataValueField="ID" Filter="Contains" EmptyMessage="Chọn sách" OnSelectedIndexChanged="rcbSach_SelectedIndexChanged" AutoPostBack="true">
                    </telerik:RadComboBox>
                ...
                <div class="col-sm-3">
                    <telerik:RadComboBox ID="rcbBaiHoc" runat="server" Width="100%" DataSourceID="objBaiHoc"
                        DataTextField="TEN_BAI_HOC" DataValueField="ID" Filter="Contains" EmptyMessage="Chọn bài học" OnSelectedIndexChanged="rcbBaiHoc_SelectedIndexChanged" AutoPostBack="true">
                    </telerik:RadComboBox>
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" GroupPanelPosition="Top" OnNeedDataSource="RadGrid1_NeedDataSource" OnItemDataBound="RadGrid1_ItemDataBound"
                ...
                <MasterTableView DataKeyNames="ID" ClientDataKeyNames="ID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="ID_TEN_BAI_HOC" FilterControlAltText="Filter ID_TEN_BAI_HOC column" HeaderText="ID_TEN_BAI_HOC" SortExpression="ID_TEN_BAI_HOC" UniqueName="ID_TEN_BAI_HOC" Display="false">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="TEN_SACH" FilterControlAltText="Filter TEN_SACH column" HeaderText="Tên sách" SortExpression="TEN_SACH" UniqueName="TEN_SACH" HeaderStyle-HorizontalAlign="Center">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="TEN_BAI_HOC" FilterControlAltText="Filter TEN_BAI_HOC column" HeaderText="Tên bài học" SortExpression="TEN_BAI_HOC" UniqueName="TEN_BAI_HOC" HeaderStyle-HorizontalAlign="Center">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="BAI_TAP" FilterControlAltText="Filter BAI_TAP column" HeaderText="Bài tập" SortExpression="BAI_TAP" UniqueName="BAI_TAP" HeaderStyle-HorizontalAlign="Center">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="NOI_DUNG" FilterControlAltText="Filter NOI_DUNG column" HeaderText="Nội dung" SortExpression="NOI_DUNG" UniqueName="NOI_DUNG" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="150px">
                        </telerik:GridBoundColumn>
                        <telerik:GridTemplateColumn DataField="ICON" UniqueName="ICON" HeaderText="Ảnh" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="110px" ItemStyle-CssClass="main-menu">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Sửa" HeaderStyle-Width="60px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" UniqueName="SUA">
                            <ItemTemplate>
                                <img src="../img/sua.png" onclick='<%# "openRadWin(\"NoiDungBaiHocDetail.aspx?id=" + Eval("ID") + "\", 860, 600, 1)" %>' style="cursor: pointer;" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
