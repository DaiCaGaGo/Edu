<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="NhapDiem.aspx.cs" Inherits="CMS.KetQuaHocTap.NhapDiem" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            $(document).on('keydown', ".text-box", function (e) {
                if (e.keyCode == 13) {
                    return false;
                }
            });
        ...
        <div class="item-filter">
            <div class="form-horizontal" role="form">
                <div class="row note-form">
                    <div class="col-sm-12">
                        <label class="content-note-form"><span style="font-weight: bold">Chú ý:</span> Với môn nhận xét, nhập Đ: đạt, C hoặc CĐ: chưa đạt</label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                        <telerik:RadComboBox ID="rcbMonHoc" runat="server" Width="100%" MaxHeight="400px" DataSourceID="objMonHoc"
