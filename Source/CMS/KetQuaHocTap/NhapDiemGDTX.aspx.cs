...
{
    public partial class NhapDiemGDTX : AuthenticatePage
    {
        ...
        private KHOA_SO_THEO_MON kstm = new KHOA_SO_THEO_MON();
        ...
        public void insertEmpty()
        {
            ...
            short? ma_khoi = localAPI.ConvertStringToShort(rcbLoaiLopGDTX.SelectedValue);
        ...
        protected void btExport_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridDataItem item in RadGrid1.Items)
            {
                ...
                foreach (DataColumn col in dt.Columns)
                {
                    ...
                    if (col.ColumnName == "DIEM_HOC_KY") row[col.ColumnName] = tbDIEM_HOC_KY.Text;
                    if (col.ColumnName == "DIEM_TRUNG_BINH_KY1") row[col.ColumnName] = tbDIEM_TRUNG_BINH_KY1.Text;
                    if (col.ColumnName == "DIEM_TRUNG_BINH_KY2") row[col.ColumnName] = tbDIEM_TRUNG_BINH_KY2.Text;
                }
                dt.Rows.Add(row);
            }
