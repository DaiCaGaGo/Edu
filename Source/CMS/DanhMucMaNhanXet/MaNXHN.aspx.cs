...
{
    public partial class MaNXHN : AuthenticatePage
    {
        private MaNhanXetBO maNXBO = new MaNhanXetBO();
        private MaNhanXetBO maBO = new MaNhanXetBO();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            btTaoMa.Visible = is_access(SYS_Type_Access.THEM);
            btnImport.Visible = is_access(SYS_Type_Access.THEM);
        ...
        {
            RadGrid1.DataSource = maNXBO.getMaNhanXet(Sys_This_Truong.ID, tbMa.Text.Trim(), tbNoiDung.Text.Trim(), Sys_This_Cap_Hoc);
        ...
        protected void btExport_Click(object sender, EventArgs e)
        {
            ...
            string tieuDe = "MÃ NHẬN XÉT HÀNG NGÀY";
        ...
        protected void btTaoMa_Click(object sender, EventArgs e)
        {
            ...
            res = maBO.insertNXHNBySys(Sys_This_Truong.ID, Sys_This_Cap_Hoc, Sys_User.ID);
            if (res.Res)
            {
