<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="MaNXHN.aspx.cs" Inherits="CMS.NhanXetHangNgay.MaNXHN" %>
    ...
    <div class="item-content">
        <div class="row item-header">
            ...
            <div class="col-sm-8 text-right">
                ...
                <asp:Button ID="btTaoMa" runat="server" Text="Tạo mã từ hệ thống" CssClass="btn bt-one" OnClick="btTaoMa_Click" OnClientClick="if(confirm('Bạn có chắc chắn muốn tạo mã từ hệ thống không?')) return true; else return false;" />
                <input type="button" id="btAddNew" runat="server" class="btn bt-one" value="Thêm mới" onclick="openRadWin('MaNXHNDetail.aspx',  860, 320, 1)" />
                <asp:LinkButton runat="server" ID="btnImport" CssClass="btn bt-one" Font-Size="17px" href="\DanhMucMaNhanXet\MaNXHN_ImportExcel.aspx">Import Excel</asp:LinkButton>
                ...
                <MasterTableView DataKeyNames="ID" ClientDataKeyNames="ID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Sửa" HeaderStyle-Width="60px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" UniqueName="SUA">
                            <ItemTemplate>
                                <img src="../img/sua.png" onclick='<%# "openRadWin(\"MaNXHNDetail.aspx?id=" + Eval("ID") + "\", 860, 400, 1)" %>' style="cursor: pointer;" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
