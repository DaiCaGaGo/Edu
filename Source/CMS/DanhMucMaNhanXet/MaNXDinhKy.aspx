<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="MaNXDinhKy.aspx.cs" Inherits="CMS.NhanXetHangNgay.MaNXDinhKy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" OnAjaxRequest="RadAjaxManager1_AjaxRequest">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="rcbLoaiNX">
                <UpdatedControls>
    ...
    <div class="item-content">
        <div class="row item-header">
            <div class="col-sm-4">
                <span class="item-title">QUẢN LÝ MÃ NHẬN XÉT ĐỊNH KỲ</span>
            </div>
            <div class="col-sm-8 text-right">
                <asp:Button ID="btTimKiem" runat="server" Text="Tìm kiếm" CssClass="btn bt-one" OnClick="btTimKiem_Click"/>
                <input type="button" id="btAddNew" runat="server" class="btn bt-one" value="Thêm mới" onclick="openRadWin('MaNXDKDetail.aspx', 860, 370, 1)" />
        ...
        <div class="item-filter">
            <div class="row">
                <div class="col-sm-3">
                    <telerik:RadComboBox ID="rcbLoaiNX" runat="server" Width="100%" EmptyMessage="Chọn loại nhận xét" Filter="Contains" OnSelectedIndexChanged="rcbLoaiNX_SelectedIndexChanged" AutoPostBack="true">
                        <Items>
                ...
                <div class="col-sm-3">
                    <telerik:RadTextBox ID="tbMa" runat="server" EmptyMessage="Nhập mã cần tìm kiếm" Width="100%"></telerik:RadTextBox>
                </div>
                <div class="col-sm-6">
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" GroupPanelPosition="Top" OnNeedDataSource="RadGrid1_NeedDataSource"
                ...
                <MasterTableView DataKeyNames="ID" ClientDataKeyNames="ID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="MA" HeaderStyle-Width="150px" FilterControlAltText="Filter MA column" HeaderText="Mã nhận xét" SortExpression="MA" UniqueName="MA" HeaderStyle-HorizontalAlign="Center">
                        ...
                        <telerik:GridBoundColumn DataField="MA_LOAI_NX" FilterControlAltText="Filter MA_LOAI_NX column" HeaderText="Mã loại nx" SortExpression="MA_LOAI_NX" UniqueName="MA_LOAI_NX" HeaderStyle-HorizontalAlign="Center" Display="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="LOAI_NX" FilterControlAltText="Filter LOAI_NX column" HeaderText="Loại nhận xét" SortExpression="LOAI_NX" UniqueName="LOAI_NX" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="300px">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="THU_TU" FilterControlAltText="Filter THU_TU column" HeaderText="Thứ tự" SortExpression="THU_TU" UniqueName="THU_TU" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="150px">
                        </telerik:GridBoundColumn>
                        <telerik:GridTemplateColumn HeaderText="Sửa" HeaderStyle-Width="60px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" UniqueName="SUA">
                            <ItemTemplate>
                                <img src="../img/sua.png" onclick='<%# "openRadWin(\"MaNXDKDetail.aspx?id=" + Eval("ID") + "\",860, 370, 1)" %>' style="cursor: pointer;" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
