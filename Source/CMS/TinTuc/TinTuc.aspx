<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="TinTuc.aspx.cs" Inherits="CMS.TinTuc.TinTuc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="item-content">
        ...
        <div class="item-filter">
            <div class="row">
                <div class="col-sm-6">
                    <telerik:RadTextBox ID="tbTieuDe" runat="server" EmptyMessage="Nhập tiêu đề hoặc nội dung cần tìm kiếm" Width="100%"></telerik:RadTextBox>
                </div>
            </div>
        </div>
        <div class="item-data">
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" GroupPanelPosition="Top" OnNeedDataSource="RadGrid1_NeedDataSource"
                ...
                <MasterTableView DataKeyNames="ID" ClientDataKeyNames="ID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="TIEU_DE" FilterControlAltText="Filter TIEU_DE column" HeaderText="Tiêu đề" SortExpression="TIEU_DE" UniqueName="TIEU_DE" HeaderStyle-HorizontalAlign="Center">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="NOI_DUNG_TOM_TAT" FilterControlAltText="Filter NOI_DUNG_TOM_TAT column" HeaderText="Nội dung tóm tắt" SortExpression="NOI_DUNG_TOM_TAT" UniqueName="NOI_DUNG_TOM_TAT" HeaderStyle-HorizontalAlign="Center">
                        </telerik:GridBoundColumn>
