...
{
    public partial class TongKetTrungBinhMonTHCS : AuthenticatePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //if (rcbHocKy.SelectedValue == "1" || rcbHocKy.SelectedValue == "2") btnTongKet.Visible = false;
            }
        }
                            ...
                            if (tong_ket_ky1 > 0)
                            {
                                ...
                                if (lstDiemChiTietHS.Count > 0)
                                {
                                    for (int i = 0; i < lstDiemChiTietHS.Count; i++)
                                    {
                                        ...
                                        if (monDetail != null && lstDiemChiTietHS[i].DIEM_TRUNG_BINH_KY1 != null)
                                        {
                                            ...
                                            {
                                                if (lstDiemChiTietHS[i].ID_MON_HOC != null && lstDiemChiTietHS[i].ID_MON_HOC == 1)
                                                    diem_toan_ky1 = lstDiemChiTietHS[i].DIEM_TRUNG_BINH_KY1.Value;
                                                else if (lstDiemChiTietHS[i].ID_MON_HOC != null && lstDiemChiTietHS[i].ID_MON_HOC == 5)
                                ...
                                if (detail != null)
                                {
                                    ...
                                    if (tong_ket_ky1 >= Convert.ToDecimal(8.0) && countCD == 0 && count_TbYKem == 0 &&
                                        (diem_toan_ky1 >= Convert.ToDecimal(8.0) || diem_nv_ky1 >= Convert.ToDecimal(8.0)))
                                    {
                                        ...
                                        if (detail.MA_HANH_KIEM_KY1 != null && detail.MA_HANH_KIEM_KY1 == 1)
                                            ...
                                            count_YKem == 0 && (diem_toan_ky1 >= Convert.ToDecimal(6.5) || diem_nv_ky1 >= Convert.ToDecimal(6.5))) ||
                                    ...
                                    else if ((tong_ket_ky1 >= Convert.ToDecimal(5.0) && countCD == 0 &&
                                    ...
                                    if (res.Res) {
                                        success++;
                                        logUserBO.insert(Sys_This_Truong.ID, "UPDATE", "Cập nhật điểm tổng kết HK 1 HS " + detail.ID_HOC_SINH, Sys_User.ID, DateTime.Now);
                                    }
                                }
                                else
                                {
                            ...
                            if (tong_ket_ky2 > 0)
                            {
                                if (detail != null)
                                {
                                    ...
                                    if (tong_ket_ky2 >= Convert.ToDecimal(8.0) && countCD_ky2 == 0 && count_TbYKem_ky2 == 0 &&
                                            (diem_toan_ky2 >= Convert.ToDecimal(8.0) || diem_nv_ky2 >= Convert.ToDecimal(8.0)))
                                    {
                                        ...
                                        if (detail.MA_HANH_KIEM_KY2 != null && detail.MA_HANH_KIEM_KY2 == 1)
                                            ...
                                            count_YKem_ky2 == 0 && (diem_toan_ky2 >= Convert.ToDecimal(6.5) || diem_nv_ky2 >= Convert.ToDecimal(6.5))) ||
                                ...
                                else
                                {
                                    ...
                                    #region điều kiện xét học lực kỳ 2
                                    int count_TbYKem_ky2 = 0, count_Tb_ky2 = 0, count_Y_ky2 = 0, count_YKem_ky2 = 0, count_Kem_ky2 = 0, count_be2_ky2 = 0;
                                    int countCD_ky2 = 0;
                                    decimal diem_toan_ky2 = 0, diem_nv_ky2 = 0;
                                    if (lstDiemChiTietHS.Count > 0)
