<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="NhanTinToCustomer.aspx.cs" Inherits="CMS.SMS.NhanTinToCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="cbHenGioGuiTin">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="divTime"/>
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
    ...
    <div class="item-content">
        <div class="row item-header">
            <div class="col-sm-5">
                <span class="item-title">GỬI TIN NHẮN THÔNG BÁO CUSTOMER</span>
            </div>
            <div class="col-sm-7 text-right">
                ...
                <asp:Button ID="btGuiTuyChon" runat="server" CssClass="btn bt-one" Text="Gửi SMS" OnClientClick="if(!btLuuClick()) return false;" OnClick="btGuiTuyChon_Click" />
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <telerik:RadComboBox ID="rcbTo" runat="server" Width="100%" DataSourceID="objTo" DataTextField="TEN" DataValueField="ID" AutoPostBack="True" EmptyMessage="Chọn tổ" Filter="Contains" CheckBoxes="true" CheckedItemsTexts="DisplayAllInInput" EnableCheckAllItemsCheckBox="true" Localization-CheckAllString="Chọn tất cả" OnClientDropDownClosed="OnClientDropDownClosed1" OnCheckAllCheck="rcbTo_CheckAllCheck" OnItemChecked="rcbTo_ItemChecked">
                                </telerik:RadComboBox>
