<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="GuiTinHangNgay.aspx.cs" Inherits="CMS.SMS.GuiTinHangNgay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="item-content">
        <div class="row item-header">
            <div class="col-sm-4">
                <span class="item-title">GỬI TIN NHẮN TỔNG HỢP HÀNG NGÀY</span>
            </div>
            <div class="col-sm-8 text-right">
                ...
                <asp:Button runat="server" ID="btnGui" CssClass="btn bt-one" Text="Gửi tin" OnClick="btnGui_Click" OnClientClick="if(!btGuiClick()) return false;"/>
            ...
            <div class="form-horizontal" role="form">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <span class="progress-description" style="color: red;"><asp:Literal ID="lblTongTinConNam" runat="server" Text=""></asp:Literal></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <span class="progress-description" style="color: red;"><asp:Literal ID="lblTongTinConThang" runat="server" Text=""></asp:Literal></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <span class="progress-description" style="color: red;"><asp:Literal ID="lblTongTinSuDung" runat="server" Text=""></asp:Literal></span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            <div class="one-checkbox col-sm-12">
                                <table>
                                    <tr>
                                        <td>
                                            <label><asp:CheckBox ID="cboGuiGVCN" runat="server" Text="Gửi GVCN"/></label>
                ...
                <MasterTableView DataKeyNames="ID_HS" ClientDataKeyNames="ID_HS">
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Nội dung nhận xét" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" UniqueName="NOI_DUNG_NX" ItemStyle-CssClass="grid-control">
                            <ItemTemplate>
                                <asp:TextBox ID="tbNoiDung" runat="server" Text='<%# Eval("NOI_DUNG_NX") %>' CssClass="form-control text-box nd-nxhn" Enabled="false" Width="100%" Height="100%"></asp:TextBox>
