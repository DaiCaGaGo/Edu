<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="LichSuTinNhan.aspx.cs" Inherits="CMS.SMS.LichSuTinNhan" %>
    ...
    <div class="item-content">
        <div class="row item-header">
            ...
            <div class="col-sm-8 text-right">
                ...
                <asp:Button ID="btnGuiLai" runat="server" CssClass="btn bt-one" Text="Cập nhật trạng thái gửi NXHN" OnClientClick="if (confirm('Bạn có chắc chắn muốn cập nhật lại trạng thái cho phép gửi lại tin nhắn?')) return true; else return false;" OnClick="btnGuiLai_Click" />
        ...
        <div class="item-filter">
            <div class="form-horizontal" role="form">
                    ...
                    <div class="col-sm-3">
                        ...
                        <asp:ObjectDataSource ID="objKhoiHoc" runat="server" SelectMethod="getKhoiByCapHocAndMaLoaiGDTX" TypeName="OneEduDataAccess.BO.KhoiBO">
                            <SelectParameters>
                                ...
                                <asp:Parameter DefaultValue="" Name="text_all" Type="String" />
                            </SelectParameters>
                ...
                <div class="row" style="margin-top: 20px;">
                    <div class="col-sm-3">
                        <telerik:RadComboBox ID="rcbLoaiTinNhan" runat="server" Width="100%" EmptyMessage="Chọn loại tin nhắn" AllowCustomText="true" Filter="Contains" AutoPostBack="true" OnSelectedIndexChanged="rcbLoaiTinNhan_SelectedIndexChanged">
                            <Items>
                    ...
                    <div class="col-sm-3">
                        <telerik:RadComboBox ID="rcbNhaMang" runat="server" Width="100%" EmptyMessage="Chọn nhà mạng" AllowCustomText="true" Filter="Contains" OnSelectedIndexChanged="rcbNhaMang_SelectedIndexChanged" AutoPostBack="true">
                            <Items>
                    ...
                    <div class="col-sm-3">
                        <telerik:RadComboBox ID="rcbTrangThai" runat="server" Width="100%" EmptyMessage="Chọn trạng thái" AllowCustomText="true" Filter="Contains" OnSelectedIndexChanged="rcbTrangThai_SelectedIndexChanged" AutoPostBack="true">
                            <Items>
                                <telerik:RadComboBoxItem Value="" Text="Tất cả" />
                ...
                <div class="row" style="margin-top: 20px;">
                    ...
                    <div class="col-sm-3">
                        <telerik:RadTextBox ID="tbSDT" runat="server" EmptyMessage="Nhập số điện thoại cần tìm kiếm" Width="100%"></telerik:RadTextBox>
                    </div>
                    <div class="col-sm-3">
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" GroupPanelPosition="Top" OnNeedDataSource="RadGrid1_NeedDataSource" OnItemDataBound="RadGrid1_ItemDataBound" AutoGenerateColumns="False" PageSize="100" AllowMultiRowSelection="True">
                ...
                <MasterTableView DataKeyNames="ID" ClientDataKeyNames="ID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="BRAND_NAME" FilterControlAltText="Filter BRAND_NAME column" HeaderText="Tên thương hiệu" SortExpression="BRAND_NAME" UniqueName="BRAND_NAME" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="100px" Display="false">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="ID_NHAN_XET_HANG_NGAY" FilterControlAltText="Filter ID_NHAN_XET_HANG_NGAY column" HeaderText="ID_NXHN" SortExpression="ID_NHAN_XET_HANG_NGAY" UniqueName="ID_NHAN_XET_HANG_NGAY" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="100px" Display="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="ID_TONG_HOP_NXHN" FilterControlAltText="Filter ID_TONG_HOP_NXHN column" HeaderText="ID_TH_NXHN" SortExpression="ID_TONG_HOP_NXHN" UniqueName="ID_TONG_HOP_NXHN" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="100px" Display="false">
                        </telerik:GridBoundColumn>
                    </Columns>
