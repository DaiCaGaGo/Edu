<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DanhSachGiaoVien.aspx.cs" Inherits="CMS.TraCuu.DanhSachGiaoVien" %>
        ...
        <table border="1" cellpadding="0" cellspacing="0" dir="ltr" style="min-width: 0px;">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="cpn-table-left-content-left"><%= listGiaoVien[i].HO_TEN%></td>
                    <td class="cpn-table-left-content-left"><%= listGiaoVien[i].SDT== null ? "&nbsp;":listGiaoVien[i].SDT.ToString()%></td>
                    <td class="cpn-table-left-content-center">
                        <a href="tel: <%= listGiaoVien[i].SDT %>" onclick="_gaq.push(['_trackEvent', 'Contact', 'Call Now Button', 'Phone']);" id="callnowbutton" style="" class="btn-callphone">&nbsp;</a>
                    </td>
                </tr>
                <%} %>
            </tbody>
