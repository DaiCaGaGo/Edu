<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPopup.Master" AutoEventWireup="true" CodeBehind="ToGiaoVienDetail.aspx.cs" Inherits="CMS.GiaoVien.ToGiaoVienDetail" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="tbTen" class="col-sm-3 control-label">Tên tổ giáo viên <span style="color: red">(*)</span></label>
                            <div class="col-sm-9">
                                <asp:TextBox ID="tbTen" CssClass="form-control" ClientIDMode="Static" placeholder="Tên tổ giáo viên" runat="server" MaxLength="100"></asp:TextBox>
