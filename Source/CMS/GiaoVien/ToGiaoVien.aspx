<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="ToGiaoVien.aspx.cs" Inherits="CMS.GiaoVien.ToGiaoVien" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="item-content">
        <div class="row item-header">
            <div class="col-sm-4">
                <span class="item-title">Quản lý tổ giáo viên</span>
            </div>
            <div class="col-sm-8 text-right">
                <asp:Button ID="btTimKiem" runat="server" Text="Tìm kiếm" CssClass="btn bt-one" OnClick="btTimKiem_Click" />
                <input type="button" id="btAddNew" runat="server" class="btn bt-one" value="Thêm mới" onclick="openRadWin('ToGiaoVienDetail.aspx', 860, 350, 1)" />
        ...
        <div class="item-filter">
            <div class="row">
                <div class="col-sm-5">
                    <telerik:RadTextBox ID="rtbTen" runat="server" EmptyMessage="Nhập tên tổ giáo viên cần tìm kiếm" Width="100%"></telerik:RadTextBox>
                </div>
            </div>
        </div>
        <div class="item-data">
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" GroupPanelPosition="Top" OnNeedDataSource="RadGrid1_NeedDataSource"
                ...
                <MasterTableView DataKeyNames="ID" ClientDataKeyNames="ID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="TEN" FilterControlAltText="Filter TEN column" HeaderText="Tên tổ giáo viên" SortExpression="TEN" UniqueName="TEN" HeaderStyle-HorizontalAlign="Center">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Sửa" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" UniqueName="SUA">
                            <ItemTemplate>
                                <img src="../img/sua.png" onclick='<%# "openRadWin(\"ToGiaoVienDetail.aspx?ma_tgv=" + Eval("ID") + "\", 860, 350, 1)" %>' style="cursor: pointer;" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>

                           <telerik:GridTemplateColumn HeaderText="Thêm GV" HeaderStyle-Width="90px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" UniqueName="THEM_GV">
                            <ItemTemplate>
                                <img src="../img/sua.png" onclick='<%# "openRadWin(\"ToGiaoVienOfGiaoVien.aspx?add_gv=" + Eval("ID") + "\",100,50)" %>' style="cursor: pointer;" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
