<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterSYS.Master" AutoEventWireup="true" CodeBehind="LichSuTinLoi_HoanTin.aspx.cs" Inherits="CMS.LichSuTinNhan.LichSuTinLoi_HoanTin" %>
    ...
    <div class="item-content">
        <div class="row item-header">
            ...
            <div class="col-sm-8 text-right">
                ...
                <asp:Button ID="btnDungGui" runat="server" CssClass="btn bt-one" OnClick="btnDungGui_Click" Text="Dừng gửi" OnClientClick="if(!btnDungGuiClick()) return false;" />
            </div>
        ...
        <div class="item-filter">
            <div class="form-horizontal" role="form">
                ...
                <div class="row" style="margin-top: 20px;">
                    ...
                    <div class="col-sm-3">
                        <telerik:RadComboBox ID="rcbTrangThai" runat="server" Width="100%" Filter="Contains" OnSelectedIndexChanged="rcbTrangThai_SelectedIndexChanged" AutoPostBack="true">
                            <Items>
                                <%--<telerik:RadComboBoxItem Value="" Text="Tất cả" />--%>
        ...
        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" GroupPanelPosition="Top" OnNeedDataSource="RadGrid1_NeedDataSource" OnItemDataBound="RadGrid1_ItemDataBound" AutoGenerateColumns="False" PageSize="100" AllowMultiRowSelection="True">
            ...
            <MasterTableView DataKeyNames="ID" ClientDataKeyNames="ID">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="LOAI_TIN" FilterControlAltText="Filter LOAI_TIN column" HeaderText="Loại tin" SortExpression="LOAI_TIN" UniqueName="LOAI_TIN" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="150px">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="SEND_NUMBER" FilterControlAltText="Filter SEND_NUMBER column" HeaderText="Số lần gửi lại" SortExpression="SEND_NUMBER" UniqueName="SEND_NUMBER" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="100px">
                    </telerik:GridBoundColumn>
